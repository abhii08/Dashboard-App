...
const DashboardBar = ({ addWidget }) => {
          ...
          <div className="space-y-4 ml-2">
            <div className="flex items-center">
              <input
                ...
                type="checkbox"
                className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded"
                onChange={() => setSelectedCategory('CWPP')}
              />
              <label
                htmlFor="widget3"
                className="ml-2 text-sm font-medium text-gray-900"
  ...
  return (
    <div className="flex justify-between px-10 py-1 h-12">
      <div className="font-bold text-lg">CNAPP Dashboard</div>
      <div className="flex justify-between px-10 py-1 h-12 gap-x-2">
        <button
          onClick={toggleDrawer}
          className="flex items-center space-x-1 px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
        >
          <span>Add Widget +</span>
        </button>
        <button
          onClick={handleRefresh}
          className="p-2 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
        >
          <svg
        ...
        <button className="flex items-center px-4 py-2 bg-white border border-blue-900 rounded shadow-sm text-gray-700 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 gap-x-1">
          ...
          <svg
            className="h-full w-px text-blue-900"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 1 24"
          >
          ...
          <svg
            className="ml-2 w-5 h-5 text-blue-900"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
      ...
      >
        <div>
          <div className="flex text-center text-sm text-white bg-blue-900 h-12">
            <p className="p-2">Add Widget</p>
          </div>
          ...
          <div className="border-b border-gray-200 mb-4">
            <div className="flex -mb-px text-sm font-medium text-center">
              <div className="mr-2">
                <button
                  onClick={() => setActiveSection('CSPM')}
                  style={{ color: activeSection === 'CSPM' ? 'blue' : 'black' }}
                  className="inline-block p-4 border-b-2 border-transparent hover:text-blue-600 hover:border-blue-300"
                >
                  CSPM
                </button>
              </div>
              <div className="mr-2">
                <button
                  onClick={() => setActiveSection('CWPP')}
                  style={{ color: activeSection === 'CWPP' ? 'blue' : 'black' }}
                  className="inline-block p-4 border-b-2 border-transparent hover:text-blue-600 hover:border-blue-300"
                >
                  CWPP
                </button>
              ...
              <div className="mr-2">
                <button
                  ...
                  style={{ color: activeSection === 'Image' ? 'blue' : 'black' }}
                  className="inline-block p-4 border-b-2 border-transparent hover:text-blue-600 hover:border-blue-300"
                >
                  Image
                </button>
              ...
              <div className="mr-2">
                <button
                  ...
                  style={{ color: activeSection === 'Ticket' ? 'blue' : 'black' }}
                  className="inline-block p-4 border-b-2 border-transparent hover:text-blue-600 hover:border-blue-300"
                >
                  Ticket
                </button>
